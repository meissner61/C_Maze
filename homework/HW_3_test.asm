# MIPS Assembly Code with Fixes Applied

.data
.align 2                  # Ensure 4-byte alignment
.globl arr                # Declare arr as global
arr:
    .space 60             # 15 integers * 4 bytes each = 60 bytes
...
init_inner_loop:
    ...
    # Debug: Print base address of arr
    # move $a0, $a3
...
print_done:
    ...
    move $a0, $s2              # Address saved in $s2
    li $v0, 34                 # syscall: print integer in hexadecimal
    syscall
